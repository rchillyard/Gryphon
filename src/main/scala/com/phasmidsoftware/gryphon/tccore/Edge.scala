 ...
 */
trait Edge[+V, +E] extends EdgeLike[V] with Attributed[EdgeLike[V], E]
...
trait EdgeLike[+V] {
   ...
   */
  def other[W >: V](w: W): Option[W] = Option.when(w == vertices._1)(vertices._2) orElse Option.when(w == vertices._2)(vertices._1)
...
//   * @return an optional vertex key.
//   */
//  override def other[W >: V](w: W): Option[W] = Option.when(w == _from)(_to)
//
...
abstract class BaseVertexPair[+V](_v1: V, _v2: V) extends VertexPair[V] {
   ...
   * @return an optional vertex key.
   */
  override def other[W >: V](w: W): Option[W]
