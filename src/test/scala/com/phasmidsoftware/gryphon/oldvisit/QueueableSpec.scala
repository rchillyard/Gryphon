...
//import com.phasmidsoftware.visitor.SimpleVisitor
...
//   */
//  private def takeRecursively[J](visitor: SimpleVisitor[Int, J], v: Int)(goal: Int => Boolean)(implicit queueable: Queueable[Queue[Int], Int]): SimpleVisitor[Int, J] = {
//    @tailrec
//    def inner(result: SimpleVisitor[Int, J], work: Queue[Int]): SimpleVisitor[Int, J] = queueable.take(work) match {
...
//    println(s"vxVm = $vxVm")
//
//    val visitor: PreVisitor[Int, Queue[Int]] = SimpleVisitor.createPre[Int]
//    import Queueable.*
