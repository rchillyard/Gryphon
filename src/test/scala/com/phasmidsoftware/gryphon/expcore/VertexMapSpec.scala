...
//    val vertexMap: VertexMap[String, DirectedEdge[String, Int], Unit] = OrderedVertexMap.empty
...
//    val result = target.bfsMutable(visitor)("A")(_ => false)
//    result match {
...
//
//  it should "keys" in {
//    val target: VertexMap[String, DirectedEdge[String, Int], Unit] = OrderedVertexMap.empty
...
//
//  it should "keys" in {
//    val target: VertexMap[Color, DirectedEdge[Color, Int], Unit] = UnorderedVertexMap.empty
//    target.keys shouldBe Set.empty
//  }
//
//  it should "values" in {
