...
class AdjacencySpec extends AnyFlatSpec with Matchers {
  ...
  it should "vertex" in {
    val adjacency = AdjacencyVertex(Vertex.create(() => Unordered_Bag.create[Adjacency[Int]]())(1))
  ...
  it should "vertex" in {
    val vertex1 = Vertex.create(() => Unordered_Bag.create[Adjacency[Int]]())(1)
    val vertex2 = Vertex.create(() => Unordered_Bag.create[Adjacency[Int]]())(2)
