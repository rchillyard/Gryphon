...
//import com.phasmidsoftware.gryphon.tccore.VertexMap.findAndMarkVertex
...
//   */
//  private[tccore] def findAndMarkVertex[V, X <: EdgeLike[V], P](vertexMap: Map[V, Vertex[V, X, P]], f: Vertex[V, X, P] => Unit, maybeV: Option[V], errorMessage: String): Option[V] = maybeV match {
//    case Some(z) =>
...
//   *
//   * CONSIDER merging code with duplicates.
//   *
//   * @param v a vertex.
//   * @param x an edge.
//   * @return an Option[P].
...
//
//  private def recurseOnEdgeX[J](v: V, visitor: Visitor[V, J], y: X): Visitor[V, J] = {
